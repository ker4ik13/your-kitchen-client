...
import image3 from '@/data/advantages/card3.webp';
...
const imageCards: ImageCard[] = [
	...
	},
	{
		...
		text: (
			<>
				<p>
					“Твоя кухня” предлагает фасады из экологически чистых, современных
					материалов. Мы даем возможность нашим клиентам создать индивидуальный
					дизайн, используя различные материалы.
				</p>
				<br />
				<p>
					...
					натуральных деревьев от итальянских партнеров.
				</p>
				<br />
				<p>
	...
	},
	{
		...
		text: (
			<>
				...
				<br />
				<p>
					Используем только высококачественные, прочные и износостойкие плиты
					ДСП, покрытые пластиком, от надежных поставщиков - Arpa, Lamicolor,
					Cleaf (Италия), Formica (Финляндия) и Resopal (Германия). Мы
					гарантируем, что наши плиты выдерживают воздействие влаги.
				</p>
				<br />
				<p>
	...
	},
	{
		...
		text: (
			<p>
				...
				фурнитурой от ведущих производителей, таких как Hettich (Германия), Blum
				(Австрия) под заказ. Это позволяет значительно упростить эксплуатацию
				наших кухонь и корпусной мебели, а также продлить срок их службы.
			</p>
		),
	},
	{
		...
		text: (
			<>
				...
				<br />
				<p>
					Наши клиенты могут выбрать из широкого ассортимента встраиваемой и
					отдельно стоящей техники различной функциональности и ценовых
					категорий.
				</p>
			</>
		),
					...
					<div className={styles.cards}>
						...
						<div className={styles.card}>
							...
							<p className={styles.cardText}>
								...
								необходимой бытовой техникой и товарами для дома. В компании
								представлен широкий ассортимент крупной и мелкой бытовой
								техники, а также разнообразных товаров для обустройства дома.
								Наши специалисты помогут подобрать модель в соответствии с
								вашими предпочтениями по стилю и цветовому решению. Обеспечиваем
								доставку, установку и подключение всех приобретенных приборов,
								экономя время, нервы и средства наших клиентов.
							</p>
						</div>
					</div>
					<div className={styles.upperText}>
