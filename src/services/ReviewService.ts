...
export class ReviewService {
  ...
  static async addReview (body: object): Promise<AxiosResponse<IReview>> {
    return await $api.post<IReview>(`/reviews`, body);
  }
  ...
  static async updateReview (id: string, body: object): Promise<AxiosResponse<IReview>> {
    return await $api.patch<IReview>(`/reviews/${id}`, body);
  }
}