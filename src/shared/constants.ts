...
export const pagesData: IPages = {
  ...
  portfolio: {
    name: `portfolio`,
    title: "Готовые проекты кухонь в Москве на заказ, описание и цены.",
    description:
      "Фото кухонь на заказ с ценами и подробным описанием от фабрики Твоя Кухня. Материалы, ассортимент фасадов и дизайн проекты. Сравните цены и получите консультацию дизайнера.",
    keywords:
